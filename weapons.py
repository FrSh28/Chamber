...
class pistol(guns):
    def __init__(self, SCENE, FRAME, AMMUNITION = 15):
...
class rifle(guns):
    def __init__(self, SCENE, FRAME, AMMUNITION = 30):
...
class shotgun(guns):
    def __init__(self, SCENE, FRAME, AMMUNITION = 6):
